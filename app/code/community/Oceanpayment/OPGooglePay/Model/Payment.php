 ...
 */
class Oceanpayment_OPGooglePay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_googlepay';
    protected $_formBlockType = 'opgooglepay/form';
    ...
    // GooglePay return codes of payment
	...
	{
		return Mage::getUrl('opgooglepay/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for GooglePay success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for GooglePay failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opgooglepay/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for GooglePay notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opgooglepay/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opgooglepay/form', $name);
    ...
    {
        return Mage::getUrl('opgooglepay/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to GooglePay
     *
	...
	/**
	 * Return authorized languages by GooglePay
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/googlepay_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to GooglePay
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for GooglePay success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for GooglePay failure payment
     *
     *  @param    none
