 ...
 */
class Oceanpayment_OPApplePay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'oceanpayment_applepay';
    protected $_formBlockType = 'opapplepay/form';
    ...
    // ApplePay return codes of payment
	...
	{
		return Mage::getUrl('opapplepay/payment/return', array('_secure' => true,'_nosid' => true));
	}

	/**
	 *  Return URL for ApplePay success response
	 *
	 *  @return	  string URL
	 */
    ...
    /**
     *  Return URL for ApplePay failure response
     *
     *  @return	  string URL
     */
    protected function getErrorURL()
    {
        return Mage::getUrl('opapplepay/payment/error', array('_secure' => true));
    }

	/**
	 *  Return URL for ApplePay notify response
	 *
	 *  @return	  string URL
	 */
	protected function getNoticeURL()
	{
		return Mage::getUrl('opapplepay/payment/notice', array('_secure' => true,'_nosid' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('opapplepay/form', $name);
    ...
    {
        return Mage::getUrl('opapplepay/payment/redirect', array('_secure' => true));
    }

    /**
     *  Return Standard Checkout Form Fields for request to ApplePay
     *
	...
	/**
	 * Return authorized languages by ApplePay
	 *
	 * @param	none
	 * @return	array
	 */
	protected function _getAuthorizedLanguages()
	{
        ...
        foreach (Mage::getConfig()->getNode('global/payment/applepay_payment/languages')->asArray() as $data) 
		{
	...
	/**
	 * Return language code to send to ApplePay
	 *
	 * @param	none
	 * @return	String
	 */
    ...
    /**
     *  Return response for ApplePay success payment
     *
     *  @param    none
    ...
    /**
     *  Return response for ApplePay failure payment
     *
     *  @param    none
